...
_CONFIGS = (
    ...
    ("n32-s3-g104", "drafter_sm120_bf16_qkv32_n32_s3_g104", _GENEROUS_WORKSPACE_BYTES),
    ("amp-s4", "drafter_sm120_bf16_qkv32_amp_s4", _GENEROUS_WORKSPACE_BYTES),
    ...
    ("amp-n64-s5", "drafter_sm120_bf16_qkv32_amp_n64_s5", _GENEROUS_WORKSPACE_BYTES),
    ("amp-n64-s6", "drafter_sm120_bf16_qkv32_amp_n64_s6", _GENEROUS_WORKSPACE_BYTES),
    ("amp-n128-s5", "drafter_sm120_bf16_qkv32_amp_n128_s5", _GENEROUS_WORKSPACE_BYTES),
    ("amp-n128-s6", "drafter_sm120_bf16_qkv32_amp_n128_s6", _GENEROUS_WORKSPACE_BYTES),
