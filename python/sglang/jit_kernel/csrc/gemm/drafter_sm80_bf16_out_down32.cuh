...
template <>
struct WarpShape<32, 32> {
  using Type = cutlass::gemm::GemmShape<16, 32, 32>;
};

template <>
struct WarpShape<64, 32> {
  using Type = cutlass::gemm::GemmShape<16, 32, 32>;
};

template <>
struct WarpShape<64, 64> {
  using Type = cutlass::gemm::GemmShape<16, 32, 64>;
};
...
template <int K, int TileN, int TileK, int Stages>
using Projection32Gemm = cutlass::gemm::device::GemmUniversal<
    ...
    typename WarpShape<TileN, TileK>::Type,
...
inline void drafter_sm80_bf16_projection32_schedule(
  ...
  static_assert(TileK == 32 || (TileN == 64 && TileK == 64));
  static_assert(Stages >= 4 && Stages <= 8);
  using Gemm = Projection32Gemm<K, TileN, TileK, Stages>;
...
#define SGLANG_DRAFTER_PROJECTION32_DEFINE(name, k, tile_n, tile_k, stages)      \
  inline void name(                                                              \
      tvm::ffi::TensorView output,                                               \
      tvm::ffi::TensorView activation,                                           \
      tvm::ffi::TensorView weight,                                               \
      tvm::ffi::TensorView workspace) {                                          \
    drafter_sm80_bf16_projection32_schedule<k, tile_n, tile_k, stages>(          \
        output, activation, weight, workspace);                                  \
  }

SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_out32_n32_s4, 2048, 32, 32, 4)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_out32_n32_s5, 2048, 32, 32, 5)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_out32_n32_s6, 2048, 32, 32, 6)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_out32_n32_s7, 2048, 32, 32, 7)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_out32_n32_s8, 2048, 32, 32, 8)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_out32_n64_s5, 2048, 64, 32, 5)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_out32_n64k64_s6, 2048, 64, 64, 6)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_out32_n64k64_s7, 2048, 64, 64, 7)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_out32_n64k64_s8, 2048, 64, 64, 8)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_down32_n32_s4, 3072, 32, 32, 4)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_down32_n32_s5, 3072, 32, 32, 5)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_down32_n32_s6, 3072, 32, 32, 6)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_down32_n32_s7, 3072, 32, 32, 7)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_down32_n32_s8, 3072, 32, 32, 8)
SGLANG_DRAFTER_PROJECTION32_DEFINE(
    drafter_sm80_bf16_down32_n64_s5, 3072, 64, 32, 5)
